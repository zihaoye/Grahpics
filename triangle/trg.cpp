...
int main(){
    ...
    // note that this is allowed, the call to glVertexAttribPointer registered BBO as the vertex attribute's bound vertex buffer object so afterwards we can safely unbind
    glBindBuffer(GL_ARRAY_BUFFER, 0);

    // You can unbind the VAO afterwards so other VAO calls won't accidentally modify this VAO, but this is rarely happens. Modifying other
